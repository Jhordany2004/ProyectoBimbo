...
{
    public partial class FormPreguntaEncuesta : Form
    {
        public FormPreguntaEncuesta()
        {
            InitializeComponent();
            listarPreguntas();
        ...
        private void FormPreguntaEncuesta_Load(object sender, EventArgs e)
        {

        }

        private void cboEncuesta_SelectedIndexChanged(object sender, EventArgs e)
        {
