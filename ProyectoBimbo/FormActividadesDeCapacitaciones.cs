...
{
    public partial class FormActividadesDeCapacitaciones : Form
    {
        private logActividad ActividadLogica;
        private entActividad ActividadSeleccionado;
        public FormActividadesDeCapacitaciones()
        {
            InitializeComponent();
            ActividadLogica = new logActividad();
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            entActividad nuevoActividad = new entActividad
            {
        ...
        private void listaActividades_SelectionChanged(object sender, EventArgs e)
        {
            if (listaActividades.SelectedRows.Count > 0)
            {
                ...
                ActividadSeleccionado = (entActividad)listaActividades.SelectedRows[0].DataBoundItem;
