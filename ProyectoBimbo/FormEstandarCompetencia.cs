...
namespace ProyectoBimbo
{
    public partial class FormEstandarCompetencia : Form
    {
        ...
        private void gbxDescripciónEstandar_Enter(object sender, EventArgs e)
        {
        ...
        private void FormEstandarCompetencia_Load(object sender, EventArgs e)
        {
